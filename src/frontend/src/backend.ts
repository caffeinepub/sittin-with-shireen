...
export class Backend implements backendInterface {
    ...
    async addVideo(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addVideo(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideos(): Promise<Array<[string, ExternalBlob]>> {
        if (this.processError) {
            try {
    ...
    async updateEpisode(arg0: Episode): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEpisode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_tuple_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _ExternalBlob]): Promise<[string, ExternalBlob]> {
    return [
        value[0],
        await from_candid_ExternalBlob_n19(_uploadFile, _downloadFile, value[1])
    ];
}
